...
describe('Testing the Github Repository', () => {
  ...
  it('Testing the getAccessToken method', async () => {
  ...
  it('Testing the getUserData method', async () => {
    const mockedAxios = Mock.of<AxiosStatic>({
      request: jest.fn().mockResolvedValue({
        data: {
          name: 'Unit test',
  ...
  it('Testing the getOrgs method', async () => {
    const mockedAxios = Mock.of<AxiosStatic>({
      request: jest.fn().mockResolvedValue({
        data: [
          {
